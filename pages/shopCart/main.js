				...
				u = {
					...
					methods: {
							...
							this.cart_total = 0, o.cart_lists = [], a.default.POST({
								...
								console.log("shopcart -- ", n), o.labels = [], n ? (n.forEach((function(t, n) {
									o.labels.push({
										...
										t.isKill && (t.killPrice = t.killPrice / 100), t.price = t.price / 100, o.labels[n].prod.push(!
											1), o.cart_total++
									}))
						...
						choose_order: function(t, o, n) {
							...
							if ("company" == t) {
								...
								e.$set(e.labels[o].prod, n, !i), e.labels[o].prod.forEach((function(t, o) {
									t && r++
								})), r === e.labels[o].prod.length ? e.$set(e.labels[o], "company", !0) : e.$set(e.labels[o], "company", !
									1)
							}
							this.choose_all()
						},
						...
						toPay: function() {
							...
							})), 0 != t.length ? this.checkOneCompany() ? (n.shopcartModelList = [].concat(t), n.allNum = 0, n.shopcartModelList
								.forEach((function(t) {
									n.allNum += t.num
